    ...
    if(updateProductId !== null){
     ...
     const deleteCategory = async(categoryId)=>{
      const toastId = toast.loading("Loading...");
        try{
            const response = await fetch(`https://ecomm-backend-aopz.onrender.com/api/v1//deleteCategory/${categoryId}` , {
                method:"DELETE",
                headers: {
                  "content-type": "application/json",
     ...
     const deleteSubCategory = async(subCatId) =>{
      ...
      try{
        ...
        const response = await fetch(`https://ecomm-backend-aopz.onrender.com/api/v1//deleteSubCategory/${subCatId}` , {
          method:"DELETE",
          headers: {
            "content-type": "application/json",
            Authorization: `Bearer ${token}`,
