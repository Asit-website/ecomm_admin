...
function CreateCategory({setSelectedItem , token , updateCategoryId , setUpdateCategoryId ,updateProductId ,setUpdateSubCategoryId,setUpdateProductId ,updateSubCategoryId}){
 ...
 const submitHandler =async (e) =>{  
  ...
  const toastId = toast.loading("Loading...");
    ...
    try {
      ...
      const response = await fetch( "https://ecomm-backend-aopz.onrender.com/api/v1/createCategory", {
        method: "POST",
 ...
 const fetchCategoryDetailById = async()=>{
  try{
    const response = await fetch(`https://ecomm-backend-aopz.onrender.com/api/v1/categoryPageDetails/${updateCategoryId}` , {
      method:"GET",
      headers: {
 ...
 const updateHandler = async(e)=>{
  ...
  try {
    ...
    const response = await fetch( `https://ecomm-backend-aopz.onrender.com/api/v1/updateCategory/${updateCategoryId}`, {
      method: "PUT",
