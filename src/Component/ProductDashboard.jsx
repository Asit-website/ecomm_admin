...
function ProductDashboard({ updateCategoryId, setUpdateCategoryId, setUpdateSubCategoryId, updateSubCategoryId, updateProductId, setUpdateProductId }) {
  ...
  const fetchAllUsers = async () => {
    ...
    try {
      const response = await fetch(`https://ecomm-backend-aopz.onrender.com/api/v1/getAllUsers`, {
        method: "GET",
        headers: {
  ...
  const fetchAllProduct = async () => {
    ...
    try {
      const response = await fetch(`https://ecomm-backend-aopz.onrender.com/api/v1/totalProduct`, {
        method: "GET",
        headers: {
          "content-type": "application/json",
  ...
  return (
    <div className="w-full flex flex-col gap-10  ">
      ...
      <div className="w-full gap-3 flex flex-wrap sunshine">
