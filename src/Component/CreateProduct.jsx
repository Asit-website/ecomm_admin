...
function CreateProduct({setSelectedItem , token ,setUpdateCategoryId ,updateSubCategoryId,setUpdateSubCategoryId,updateCategoryId , updateProductId ,setUpdateProductId}){
 ...
 const fetchProductDetailById = async()=>{
  try{
    try{
      const response = await fetch(`https://ecomm-backend-aopz.onrender.com/api/v1/getProductById/${updateProductId}` , {
        method:"GET",
        headers: {
          "content-type": "application/json",
 ...
 const submitHandler =async () =>{
  ...
  const loadingId = toast.loading("Loading...");
    ...
    try {
      ...
      const response = await fetch( "https://ecomm-backend-aopz.onrender.com/api/v1/createProduct", {
        method: "POST",
  ...
  const updateProductHandler = async()=>{
    ...
    try {
      ...
      const response = await fetch( `https://ecomm-backend-aopz.onrender.com/api/v1/updateProduct/${updateProductId}`, {
        method: "PUT",
