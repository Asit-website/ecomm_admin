  ...
  return (
    <>
      ...
      <div className="w-full min-h-[100vh] lg:mt-16">
        ...
        <aside
          id="default-sidebar"
          className="fixed top-0 left-0 z-50 w-72 h-screen transition-transform -translate-x-full sm:translate-x-0"
          aria-label="Sidebar"
        >
          <header className="w-full h-16 flex items-center ps-6 pt-1 bg-[#273a8a]">
            <Link to="#" onClick={() => setSelectedItem("dashboard")}>
              <span className="text-md font-[600] text-[#ffffff]">
                DASHBOARD
              </span>
            </Link>
          </header>
        ...
        <div className="sm:ml-[18rem]  min-h-[100vh]">
          {selectedItem === "dashboard" && (
            <ProductDashboard
